...
public class Level1State extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/Backgrounds/sky.gif", 0.5, 0);
		...
		try {
			level1 = ImageIO.read(
				getClass().getResourceAsStream("/HUD/Level1.gif")
			);
			title = new Title(level1.getSubimage(0, 0, 197, 43));
			title.sety(22);
		}
		catch(Exception e) {
			e.printStackTrace();
