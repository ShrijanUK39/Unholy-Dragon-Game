...
import shrijan.game.Entity.Portal;
import shrijan.game.Entity.Spirit;
import shrijan.game.Entity.Title;
import shrijan.game.Entity.Dragon.BottomLeftPiece;
import shrijan.game.Entity.Dragon.BottomRightPiece;
import shrijan.game.Entity.Dragon.TopLeftPiece;
import shrijan.game.Entity.Dragon.TopRightPiece;
import shrijan.game.Entity.Enemies.DarkEnergy;
...
public class Level4State extends GameState {
	...
	public void init() {
		...
		// backgrounds
		temple = new Background("/Backgrounds/skeli.gif", 0.5, 0);
		...
		// title and subtitle
				try {
					level4 = ImageIO.read(
						getClass().getResourceAsStream("/HUD/Level4.gif")
					);
					title = new Title(level4.getSubimage(0, 0, 204, 43));
					title.sety(42);
				}
				catch(Exception e) {
					e.printStackTrace();
		...
		// music
		JukeBox.load("/Music/level4boss.mp3", "level4boss");
	...
	private void eventPortal() {
		...
		if(eventCount == 362) {
			...
			JukeBox.loop(
				...
				0,
				60000,
				JukeBox.getFrames("level4boss") - 4000
			);
		}
		if(eventCount == 420) {
