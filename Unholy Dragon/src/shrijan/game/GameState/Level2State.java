...
public class Level2State extends GameState {
	...
	public void init() {
		...
		// backgrounds
		sky = new Background("/Backgrounds/sunset.gif", 0);
		...
		try {
			level2 = ImageIO.read(
				getClass().getResourceAsStream("/HUD/Level2.gif")
			);
			title = new Title(level2.getSubimage(0, 0, 203, 43));
			title.sety(45);
	...
	private void populateEnemies() {
		...
		Tengu t;
		g = new Gazer(tileMap);
		g.setPosition(500, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(550, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(600, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(650, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(720, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(780, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(1100, 90);
		enemies.add(g);
		g = new Gazer(tileMap);
		g.setPosition(2140, 70);
		enemies.add(g);
		
		gp = new GelPop(tileMap, player);
		gp.setPosition(950, 50);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1000, 100);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		...
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2730, 95);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2770, 95);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(2900, 100);
		enemies.add(t);
		t = new Tengu(tileMap, player, enemies);
		t.setPosition(3000, 100);
		enemies.add(t);
